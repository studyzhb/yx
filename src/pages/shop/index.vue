...
<el-table-column prop="addr" label="身份证号" width="180" sortable>
</el-table-column>
<el-table-column prop="sex" label="注册时间" width="180" :formatter="formatSex" sortable>
</el-table-column>
<el-table-column inline-template :context="_self" label="操作" min-width="320">
	<span>
        <el-button size="small" >队列资料</el-button>
