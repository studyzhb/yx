...
<el-table-column prop="name" label="昵称" width="100" sortable>
</el-table-column>
<el-table-column prop="name" label="姓名" width="100" sortable>
</el-table-column>
<el-table-column prop="addr" label="身份证号" width="120" sortable>
</el-table-column>
<el-table-column prop="sex" label="注册时间" width="120" :formatter="formatSex" sortable>
</el-table-column>
<el-table-column prop="sex" label="绑定店铺" width="150" :formatter="formatSex" sortable>
</el-table-column>
...
<el-table-column inline-template :context="_self" label="操作" min-width="200">
	<span>
        <el-button size="small" @click="handleEdit(row)">流水</el-button>
