    ...
    <section>
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item label="店铺">
                    <el-select v-model="filters.region" placeholder="请选择店铺">
        ...
        <template>
            <el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;">
                ...
                <el-table-column prop="name" label="标题" width="100" sortable>
                </el-table-column>
                <el-table-column prop="name" label="摘要" width="100" sortable>
                </el-table-column>
                <el-table-column prop="name" label="店铺" width="100" sortable>
                </el-table-column>
                <el-table-column prop="addr" label="审核" width="120" sortable>
                </el-table-column>
                <el-table-column prop="sex" label="时间" width="120" :formatter="formatSex" sortable>
                </el-table-column>
