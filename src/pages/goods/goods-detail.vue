    ...
    <section>
        ...
        <el-col :span="24" class="toolbar">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="未编辑" name="second"></el-tab-pane>
                <el-tab-pane label="已编辑" name="third"></el-tab-pane>
            </el-tabs>
        </el-col>
        <!--列表-->
        <template>
            <el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;">
                ...
                <el-table-column prop="name" label="商品编码" width="120" sortable>
                </el-table-column>
                <el-table-column prop="name" label="国际条形码" width="120" sortable>
                </el-table-column>
                <el-table-column prop="addr" label="供应商" width="180" sortable>
                </el-table-column>
